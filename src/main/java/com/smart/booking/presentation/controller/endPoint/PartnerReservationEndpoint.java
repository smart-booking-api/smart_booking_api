...
public class PartnerReservationEndpoint {
    ...
    public static final String RESERVATION_PARTNER_CREATE_PHONE_RESERVATION = RESERVATION_ROOT;
    public static final String RESERVATION_PARTNER_CANCEL_PHONE_RESERVATION = RESERVATION_ROOT + "/{reservationId}";
