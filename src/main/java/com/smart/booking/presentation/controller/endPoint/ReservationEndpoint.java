...
public class ReservationEndpoint {
    ...
    public static final String RESERVATION_CREATE_PHONE_RESERVATION = RESERVATION_ROOT + "/partner/reservation";
    ...
    public static final String MONTHLY_USER_RESERVATION_HISTORY = RESERVATION_ROOT + "/history";
