...
public class ReservationEndpoint {
    ...
    public static final String CREATE_USER_RESERVATION = RESERVATION_ROOT + "/reservation";
    public static final String MONTHLY_USER_RESERVATION_HISTORY = RESERVATION_ROOT + "/reservation/history";
    public static final String UPDATE_RESERVATION_STATUS = RESERVATION_ROOT + "/reservation/status";
